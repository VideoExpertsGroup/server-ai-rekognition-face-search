...
class TestVXGClientIntegration(TestCase):
    ...
    def test_get_unprocessed_events(self):
        ...
        for event in events:
            ...
            self.assertNotIn(self.vxg.TAG_PROCESSING, event_details['meta'])
            self.assertNotIn(self.vxg.TAG_HAS_FACE, event_details['meta'])
            self.assertNotIn(self.vxg.TAG_NO_FACE, event_details['meta'])
    ...
    def test_event_processing(self):
        ...
        if len(events):
            ...
            self.assertNotIn(self.vxg.TAG_PROCESSING, event_after_clear['meta'])
    ...
    def test_event_processed_has_faces(self):
        ...
        if len(events):
            ...
            self.vxg.set_event_processed(event_id, sample_faces)
            event_after_set = self.vxg.get_event_details(event_id)
